          ...
          <Box pb="20px">
            ...
            >
              <Box>
                ...
                <Center>
                  <Text mt="10px" as="b" fontWeight={"500"}>
                    Your Cart is empty!
                  </Text>
                </Center>
                <Center>
                  <Text
                    ...
                    w="62%"
                  >
                    You have no items added in the cart. Explore and add
                    products you like!
                  </Text>
                </Center>
                <Center>
            ...
            <Box mt="50px">
              <Box w="50%" p="15px" m="auto" borderRadius={"10px"} bg="#fff">
                {saveForLaterData ? (
                      ...
                      >
                        ...
                        <Flex w="100%">
                          <Box w="100%">
                            ...
                            <Text fontSize={"12px"} color="#151B3999">
                              QTY: {el.quantity ? el.quantity : 1}
                            </Text>
                            <Text fontSize={"12px"} color="#151B3999">
                              Mfr: {el.manufacturer}
                            </Text>
                          ...
                          <Box w="20%">
                            <Center>
                              <Text fontWeight={"600"} color="#ef4281">
                                Rs.{el.actual_price.toFixed(2)}
                              </Text>
                            </Center>
                            {el.crossed_price && (
                              <Center>
                  ...
                  <Center>
                    <Box>
                      <Text color="#151B3999" as="b" letterSpacing="1px">
                        SAVED FOR LATER
                      </Text>
                      <Text fontSize={"12px"} color="#151B3999" mt="10px">
            ...
            <Box w="100%">
                    ...
                    {cartData.map((el) => (
                      ...
                      >
                        <Box display={{ base: "block", lg: "flex" }}>
                          <Box>
                            <Image
                              w={{ base: "120px", lg: "40px" }}
                              h={{ base: "100px", lg: "40px" }}
                              src={el.img1}
                            ></Image>
                          </Box>
                          <Box ml="20px">
                            <Text mb="-5px">{el.title}</Text>
                            <Text fontSize={"12px"} color="#151B3999" as="i">
                              Mfr: {el.manufacturer}
                            </Text>
                          </Box>
                        </Box>
                        ...
                        >
                          <Box
                            ...
                            alignItems={"flex-end"}
                          >
                            <Text fontWeight={"600"} color="#ef4281" mr="5px">
                              Rs. {parseFloat(el.actual_price).toFixed(2)}
                            </Text>
                            {el.crossed_price && (
                              <Text
                                color="#151B3999"
                                ...
                                fontSize={"12px"}
                              >
                                Rs. {parseFloat(el.crossed_price).toFixed(2)}
                              </Text>
                            )}
                          </Box>
                          <Box>
                            ...
                            <Select
                              placeholder={el.quantity ? el.quantity : 1}
                              onChange={(e) => handleQuantity(e, el.id)}
                            >
                        ...
                        >
                          ...
                          >
                            <Text fontSize={"12px"}>
                              ...
                              <span style={{ fontSize: "13px" }}>
                                ...
                                {date.toString().substring(0, 8)}
                                {+date.toString().substring(8, 10) + 1}
                              </span>
                            </Text>
                          </Box>
                          <Box
                          ...
                          >
                            <Button
                              ...
                              _hover={"none"}
                              letterSpacing={"1px"}
                              onClick={() => removeCart(Cart_API, el.id)}
                            >
                              REMOVE
                            </Button>
                            <Button
                              onClick={() => handleSaveForLater(el)}
                              bg="#F6F6F7"
                              fontSize={"12px"}
                              color="#151B3999"
                              size="sm"
              ...
              <Box m="20px 0" p="15px" bg="#fff" borderRadius={"7px"}>
                ...
                {saveForLaterData ? (
                        ...
                        <Box w="100%">
                          <Box w="100%">
                            ...
                            >
                              ...
                              <Box
                                display={{ base: "block", md: "flex-column" }}
                              >
                                <Text fontWeight={"600"} color="#ef4281">
                                  Rs.{el.actual_price.toFixed(2)}
                                </Text>
                  ...
                  <Box>
                    <Text mt="5px" fontSize={"12px"} color="#151B3999">
                      No items in save for later
                    </Text>
                  </Box>
                )}
            ...
            <Box w={{ base: "100%", lg: "45%" }}>
              <Box p="10px" pb="20px" borderRadius={"5px"} bg="#fff" mb="15px">
                <Box>
                  ...
                  <Checkbox
                    onChange={() => handlePromo(showHidden)}
                    colorScheme={"teal"}
                  >
                    Apply Promo Code
                  </Checkbox>
                  <Center>
                    <Text color="#151B3999" w="80%" mt="10px" fontSize={"12px"}>
                ...
                <Box mt="30px" pos="relative">
                  <Box ref={promeRef} display="none">
                    <Text color="#24aeb1" fontSize={"12px"} fontWeight="600">
                      PROMOCODE
                    </Text>
                    <Box>
                      <Input
                    ...
                    {validPromoCode === false && (
                      <Text color="red">Invalid promocode</Text>
                    )}
                  </Box>
                </Box>
              </Box>
              <Box p="10px" pb="20px" borderRadius={"5px"} bg="#fff" mb="15px">
                <Box p="5px">
                  ...
                  {promoCodeDiscount == 0 ? (
                    ...
                    >
                      ...
                      <Text>
                        -Rs.{parseFloat(promoCodeDiscount).toFixed(2)}
                      </Text>
                    </Flex>
                  )}
                  <Flex
                  ...
                  >
                    ...
                    <Text as="b">
                      Rs.
                      {parseFloat(
                        totalMRP - discount - promoCodeDiscount
                      ).toFixed(2)}
                    </Text>
                  </Flex>
                </Box>
                <Box bg="#f3f8ec" p="10px 15px" mb="30px">
                  <Text
                    ...
                    letterSpacing="1px"
                  >
                    TOTAL SAVINGS RS.{parseFloat(discount).toFixed(2)}
                  </Text>
                </Box>
              ...
              <Box mt="-20px" p="15px">
                <Text as="i" fontSize={"10px"} lineHeight="-10px">
                  ...
                  <span style={{ color: "#0033ff" }}>Terms & Conditions</span>
                </Text>
              </Box>
            </Box>
          </Box>
